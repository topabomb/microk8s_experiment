...
5.
```
sudo gitlab-runner register --url https://172.18.72.28/ --registration-token T6r6zUWUJfgQAm2kXjj- --name gitlab-local --tag-list local --executor docker --docker-image=node:lts-alpine
```
